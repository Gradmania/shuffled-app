...
import { Star, Heart, Home, Search, Shield, Crown, Trophy, Award, Globe, Target, Crosshair, Layers, Copy, Download, RefreshCw, RotateCcw, TrendingUp, Activity, Hash, Mountain, Sunrise, Ghost, Skull, Brain, Magnet, Diamond, Gem, Hexagon, Pentagon, Octagon, Triangle, Square, Circle, BookOpen, Palette, Link2, Wine, Cake, Clock, Zap, Sparkles, Moon, Sun, Flame, ChevronUp, ArrowUp, Compass, Rainbow, Repeat, GitBranch, Footprints, CalendarDays, CalendarCheck, CalendarRange, Route, CopyCheck, ShieldPlus, Boxes, Grid2x2, LayoutGrid, CircuitBoard, Flower2, ArrowUpCircle, MoonStar, SunMoon, Palmtree, CircleOff, FlipHorizontal2, Factory, Paintbrush, Droplets } from 'lucide-react';
...
const FINDS_CATALOGUE = [
  ...
  { id: 'colour-6', name: 'Colour Streak 6', Icon: Palette, rarity: 'Uncommon', desc: 'Six+ same colour in a row' },
  ...
  { id: 'colour-8', name: 'Colour Streak 8', Icon: Paintbrush, rarity: 'Rare', desc: 'Eight same colour in a row' },
  ...
  { id: 'colour-10', name: 'Colour Streak 10', Icon: Droplets, rarity: 'Very Rare', desc: 'Ten same colour in a row' },
  ...
  { id: 'factory-run', name: 'Factory Run 4+', Icon: Factory, rarity: 'Extraordinary', desc: '4+ consecutive cards in factory deck order' },
...
const TROPHY_ACHIEVEMENTS = [
  { id: 'first-step', name: 'First Step', Icon: Footprints, desc: 'Complete your first shuffle', category: 'Streaks' },
  { id: 'week-walker', name: 'Week Walker', Icon: CalendarDays, desc: '7 day streak', category: 'Streaks' },
  { id: 'fortnight', name: 'Fortnight', Icon: CalendarCheck, desc: '14 day streak', category: 'Streaks' },
  { id: 'month-maven', name: 'Month Maven', Icon: CalendarRange, desc: '30 day streak', category: 'Streaks' },
  { id: 'quarter-quest', name: 'Quarter Quest', Icon: Mountain, desc: '90 day streak', category: 'Streaks' },
  { id: 'the-long-walk', name: 'The Long Walk', Icon: Route, desc: '365 day streak', category: 'Streaks' },
  { id: 'double-digits', name: 'Double Digits', Icon: Hash, desc: '10 total shuffles', category: 'Shuffle Totals' },
  { id: 'half-century', name: 'Half Century', Icon: Target, desc: '50 total shuffles', category: 'Shuffle Totals' },
  { id: 'century-club', name: 'Century Club', Icon: Award, desc: '100 total shuffles', category: 'Shuffle Totals' },
  { id: 'full-orbit', name: 'Full Orbit', Icon: Globe, desc: '365 total shuffles', category: 'Shuffle Totals' },
  { id: 'close-call', name: 'Close Call', Icon: Crosshair, desc: 'Match 5+ positions', category: 'Match Milestones' },
  { id: 'lucky-seven', name: 'Lucky Seven', Icon: LuckySevenIcon, desc: 'Match 7+ positions', category: 'Match Milestones' },
  { id: 'near-miss', name: 'Near Miss', Icon: Sparkles, desc: 'Match 8+ positions', category: 'Match Milestones' },
  { id: 'the-impossible', name: 'The Impossible', Icon: Zap, desc: 'Match 9+ positions', category: 'Match Milestones' },
  { id: 'ghost-town', name: 'Ghost Town', Icon: Ghost, desc: 'Get a 0-match', category: 'Match Experiences' },
  { id: 'twins', name: 'Twins', Icon: CopyCheck, desc: 'Same match count two days in a row', category: 'Match Experiences' },
  { id: 'the-other-half', name: 'The Other Half', Icon: Link2, desc: 'A past shuffle gets matched by someone new', category: 'Match Experiences' },
  { id: 'full-spectrum', name: 'Full Spectrum', Icon: Rainbow, desc: 'See every tier from Ghost to Singularity', category: 'Match Experiences' },
  { id: 'curious', name: 'Curious', Icon: Search, desc: 'Discover 5 unique finds', category: 'Collection Progress' },
  { id: 'explorer', name: 'Explorer', Icon: Compass, desc: 'Discover 15 unique finds', category: 'Collection Progress' },
  { id: 'cataloguer', name: 'Cataloguer', Icon: BookOpen, desc: 'Discover 25 unique finds', category: 'Collection Progress' },
  { id: 'something-rare', name: 'Something Rare This Way Comes', Icon: Gem, desc: 'First Rare find', category: 'First Discovery' },
  { id: 'against-the-odds', name: 'Against the Odds', Icon: Diamond, desc: 'First Very Rare find', category: 'First Discovery' },
  { id: 'one-in-a-million', name: 'One in a Million', Icon: Star, desc: 'First Extraordinary find', category: 'First Discovery' },
  { id: 'royal-witness', name: 'Royal Witness', Icon: Crown, desc: 'Discover a Royal Flush', category: 'First Discovery', legendary: true },
  { id: 'blank-slate', name: 'Blank Slate', Icon: Square, desc: '0 cards in factory position', category: 'Factory Position' },
  { id: 'deja-vu', name: 'Déjà Vu', Icon: Home, desc: '2+ cards in factory position', category: 'Factory Position' },
  { id: 'homing-instinct', name: 'Homing Instinct', Icon: Magnet, desc: '3+ cards in factory position', category: 'Factory Position' },
  { id: 'the-deck-remembers', name: 'The Deck Remembers', Icon: Brain, desc: '4+ cards in factory position', category: 'Factory Position' },
  { id: 'total-recall', name: 'Total Recall', Icon: CircuitBoard, desc: '5+ cards in factory position', category: 'Factory Position' },
  { id: 'rising-star', name: 'Rising Star', Icon: TrendingUp, desc: 'A past shuffle improves its best match', category: 'Retroactive' },
  { id: 'sleeper-hit', name: 'Sleeper Hit', Icon: Moon, desc: 'A shuffle 30+ days old gets a new highest match', category: 'Retroactive' },
  { id: 'late-bloomer', name: 'Late Bloomer', Icon: Flower2, desc: 'A shuffle reaches match 5+ after starting at 2 or lower', category: 'Retroactive' },
  { id: 'the-climber', name: 'The Climber', Icon: ArrowUpCircle, desc: 'A shuffle improves its best match three times', category: 'Retroactive' },
  { id: 'night-owl', name: 'Night Owl', Icon: MoonStar, desc: 'Shuffle between midnight and 4am', category: 'Fun & Personality' },
  { id: 'early-bird', name: 'Early Bird', Icon: Sun, desc: 'Shuffle between 4am and 7am', category: 'Fun & Personality' },
  { id: 'night-and-day', name: 'Night and Day', Icon: SunMoon, desc: 'Earn both Night Owl and Early Bird', category: 'Fun & Personality' },
  { id: 'weekender', name: 'Weekender', Icon: Palmtree, desc: 'Shuffle Saturday and Sunday the same weekend', category: 'Fun & Personality' },
  { id: 'monday-motivation', name: 'Monday Motivation', Icon: Flame, desc: 'Shuffle on a Monday', category: 'Fun & Personality' },
  { id: 'creature-of-habit', name: 'Creature of Habit', Icon: Clock, desc: 'Same hour, 7 days running', category: 'Fun & Personality' },
  { id: 'comeback-kid', name: 'Comeback Kid', Icon: RotateCcw, desc: 'Shuffle again after 7+ days away', category: 'Fun & Personality' },
  { id: 'jackpot', name: 'Jackpot', Icon: JackpotIcon, desc: '8+ finds in a single shuffle', category: 'Per-Shuffle Moments' },
  { id: 'phantom', name: 'Phantom', Icon: CircleOff, desc: 'Zero matches AND zero factory positions', category: 'Per-Shuffle Moments' },
  { id: 'new-horizons', name: 'New Horizons', Icon: Sunrise, desc: '3+ new finds in a single shuffle', category: 'Per-Shuffle Moments' },
  { id: 'variety-pack', name: 'Variety Pack', Icon: VarietyPackIcon, desc: 'Finds from 4+ rarity tiers in one shuffle', category: 'Variety' },
  { id: 'hat-trick', name: 'Hat Trick', Icon: Repeat, desc: 'Same match count three days in a row', category: 'Variety' },
  { id: 'connoisseur', name: 'Connoisseur', Icon: Wine, desc: 'Finds from all 6 rarity tiers', category: 'Variety' },
  { id: 'anniversary', name: 'Anniversary', Icon: Cake, desc: 'Shuffle on your one-year anniversary', category: 'Lifetime' },
  { id: 'daily-crown', name: 'Daily Crown', Icon: DailyCrownIcon, desc: 'Highest match of the day (ties count)', category: 'Lifetime' },
  { id: 'encore', name: 'Encore', Icon: RefreshCw, desc: 'Watch your shuffle again', category: 'Keepsakes' },
  { id: 'imprint', name: 'Imprint', Icon: Download, desc: 'Save your shuffle to keep', category: 'Keepsakes' },
  { id: 'completionist', name: 'Completionist', Icon: Trophy, desc: 'Discover all 35 finds', category: 'The Final Card', legendary: true },
];
